 ...
 */
final class Version20240212185306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE jeux (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, equipe_gagnante_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, points DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_3755B50D9D2B864A FOREIGN KEY (equipe_gagnante_id) REFERENCES equipe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
